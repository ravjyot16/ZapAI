...
function BlogTitles() {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      setLoading(true);
    const prompt = `Generate exactly 5 blog titles based on the keyword "${input}" for the "${selectedCategory}" category.

Output ONLY the 5 titles.
